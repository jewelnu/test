...
namespace testWeb.Controllers
{
    public class TeacherController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="TeacherId,Name,Address,Email,Contact,DesignationId,DepartmentId,CreditToBeTaken")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="TeacherId,Name,Address,Email,Contact,DesignationId,DepartmentId,CreditToBeTaken")] Teacher teacher)
        {
            if (ModelState.IsValid)
            {
